...
<html>
    ...
    <body>
        ...
        <div id="show-estudiante" class="content scaffold-show" role="main">
            ...
            <f:display bean="estudiante" />
            <g:form resource="${this.estudiante}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.estudiante}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
