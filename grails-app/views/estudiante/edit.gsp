...
<html>
    ...
    <body>
        <a href="#edit-estudiante" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
        ...
        <div id="edit-estudiante" class="content scaffold-edit" role="main">
            ...
            <g:form resource="${this.estudiante}" method="PUT">
                <g:hiddenField name="version" value="${this.estudiante?.version}" />
                <fieldset class="form">
